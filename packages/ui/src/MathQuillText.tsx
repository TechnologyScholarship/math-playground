...
export const MathQuillText: React.FunctionComponent<SizableTextProps & { children: string | (string | MathQuillInputField)[], unselectable?: boolean; }> =
  (props) => {
    React.useEffect(() => {
    ...
    React.useEffect(() => {
      let l = '';
      embedded.current = [];
      const children: (MathQuillInputField | string)[] = (typeof props.children === 'string' ? [props.children] : props.children);
